...
<nav>
    <div class="left-menu">
        ...
        <a href="#" id="beranda">Status Surat</a>
    </div>
    <div class="right-menu">
        <div class="dropdown">
            <a href="../layanan.php" id="layanan-mandiri">Layanan Mandiri <span class="arrow">▼</span></a>
            <div class="dropdown-content">
                <a href="../surat_sidebar/sku.php" id="sku">Surat Keterangan Usaha</a>
                <a href="../surat_sidebar/sktm.php" id="sktm">Surat Keterangan Tidak Mampu</a>
                <a href="../surat_sidebar/skck.php" id="skck">Surat Pengantar SKCK</a>
                <a href="status.php">Status Surat</a>
            </div>
        </div>

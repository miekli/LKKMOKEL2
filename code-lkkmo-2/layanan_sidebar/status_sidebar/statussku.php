                                        ...
                                        <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                                            <div class="modal-content">
                                                    ...
                                                    <form>
                                                        ...
                                                        <div id="struckContent" class="d-none">
                                                            ...
                                                            <div id="struk">
                                                                ...
                                                                <p><span>NIK:</span> <?php echo $row['NIK'] ?></p>
                                                                <p><span>Jenis:</span> <?php echo $row['jenis'] ?></p>
                                                                ...
                                                                <p><span>Keperluan:</span> Buka Usaha</p>
                                                                ...
                                                                <div id="signature">
                                                                    ...
                                                                    <P>Bayu W/The Ladiess and Gentlement</P>
                                                ...
                                                <div class="modal-footer">
                                                    <button onclick="printStruck()" class="btn btn-secondary">Cetak Surat SKTM</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

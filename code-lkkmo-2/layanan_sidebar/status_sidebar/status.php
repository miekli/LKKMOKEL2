    ...
    <div class="container-lg mt-5">
        <div class="row full-height">
            <div class="col-md-4 mb-4 col-sm-12 d-flex justify-content-center">
                <a href="statusskck.php" class="card" style="cursor: pointer; background-color: #2C5A9D;">
            ...
            <div class="col-md-4 mb-4 col-sm-12 d-flex justify-content-center">
                <a href="statussktm.php" class="card" style="cursor: pointer; background-color: #2C5A9D;">
            ...
            <div class="col-md-4 mb-4 col-sm-12 d-flex justify-content-center">
                <a href="statussku.php" class="card" style="cursor: pointer; background-color: #2C5A9D;">

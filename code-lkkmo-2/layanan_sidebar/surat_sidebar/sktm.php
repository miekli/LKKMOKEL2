...
<body style="height: auto;">
    ...
    <div class="container-lg mt-5">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <form action="../../admin_sidebar/proses/prosessktm.php" class="form-container" method="POST">
                <div class="form-table">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-input">
                            <input type="text" class="form-control" id="floatingInput" placeholder="Tempat Lahir Anda" name="tempat" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-input">
                            <input type="text" class="form-control" id="floatingInput" placeholder="Status Pernikahan Anda" name="status" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-input">
                            <input class="form-control" id="input_ktp" type="file" aria-describedby="file_input_help" name="upload" required>

...
<nav>
    ...
    <div class="right-menu">
        <div class="dropdown">
            <a href="/belajarphp/layanan_sidebar/layanan.php" id="layanan-mandiri">Layanan Mandiri <span class="arrow">▼</span></a>
            <div class="dropdown-content">
                <a href="../../layanan_sidebar/surat_sidebar/sku.php" id="sku">Surat Keterangan Usaha</a>
                <a href="../../layanan_sidebar/surat_sidebar/sktm.php" id="sktm">Surat Keterangan Tidak Mampu</a>
                <a href="../../layanan_sidebar/surat_sidebar/skck.php" id="skck">Surat Pengantar SKCK</a>
                <a href="../status_sidebar/status.php">Status Surat</a>
            </div>
        </div>

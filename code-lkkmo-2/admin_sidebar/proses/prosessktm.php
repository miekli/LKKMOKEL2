...
$query = mysqli_query($conn, "INSERT INTO tb_sktm (username,nama,NIK,jenis,tempat,tanggal,agama,perkerjaan,status,alamat,upload,info) values ('$username','$nama','$NIK','$jenis','$tempat','$tanggal','$agama','$perkerjaan','$status','$alamat','$upload','$info')");
if (!$query) {
